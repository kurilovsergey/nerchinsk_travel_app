     ...
     <View style={styles.drawerHeader}>
        <ImageBackground source={require('./assets/images/index.jpg')}
             ...
             <View style={{alignItems:'center'}}>
                <Text style={styles.drawerHeaderText}> Гид по Нерчинску </Text>
             </View>
        </ImageBackground>
     </View>
...
export default function App() {
    return (
      ...
      <NavigationContainer>
        ...
        >
          <Drawer.Screen name="Домой" component={HomeStackScreen} 
          ...
          />
          <Drawer.Screen name="Все места" component={ExampleStackScreen} 
            options={{ drawerIcon: ({tintColor}) => (
